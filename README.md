...
| `replace-text --page NAME --find TEXT --replace TEXT` | Search & replace with regex and dry-run support. A replacement that turns a line into an `id::` line is refused before any block is written |
